  ...
  return (
    ...
    initial={{opacity:0.2, y:100}} transition={{duration:1}} whileInView={{opacity:1, y:0}} viewport={{once:true}}>
        ...
        initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{delay:0.6, duration:0.8}}>
          Bring ideas to life with AI. Describe your vision – our model turns words into stunning visuals instantly. Type, generate, be amazed.</motion.p>
        ...
        className='mt-2 text-neutral-600'>Generated images from Promptify</motion.p>
    </motion.div>
  )
}
