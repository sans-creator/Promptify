...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
        ...
        <p className='text-center max-w-xl mx-auto mt-5'>Bring ideas to life with AI. Describe your vision – our model turns words into stunning visuals instantly. Type, generate, be amazed.</p>
        ...
        <p className='mt-2 text-neutral-600'>Generated images from Promptify</p>
    </div>
  )
}
