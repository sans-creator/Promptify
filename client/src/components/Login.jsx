...
//to stop scrolling
  ...
  useEffect(()=>{
    ...
    return ()=>{ // Restore scrolling when the form unmounts
  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-[9999] backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      {state!=='Login' &&
        ...
        <div className='boreder px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
          <img src={assets.email_icon} alt="" />
          <input type="email" placeholder='Enter Enail' required className='outline-none text-sm ' />
        </div>
        <div className='boreder px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
